...
- **`src/digital-twin`** — Virtual Socky: React/Three.js robot simulator and animation desk.
...
Open Virtual Socky at **http://127.0.0.1:5173**, connect it to **ws://127.0.0.1:8787**, then open the puppeteer at **http://127.0.0.1:8788**. Click **Start listening** and allow microphone access. The twin's fixture server must be stopped because it uses the same robot port.
